"""
Django settings for tst_rn_web_1 project.
...
ROOT_URLCONF = 'tst_rn_web_1.urls'
...
WSGI_APPLICATION = 'tst_rn_web_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_rn_web_1 API",
    "DESCRIPTION": "API documentation for tst_rn_web_1 App",
    "VERSION": "v1",
}
